...
if (isset($_POST["submit"])) {
    ...
    mysqli_query($conn, "UPDATE `trainer` SET tname = '$tname', tyear = '$tyear',
    fees = '$fees', tpic = '$tpic', tfrom = '$tfrom', tto = '$tto', tid = '$tid' WHERE tid = $tid")or die('query failed');;

echo "<script>
alert('Trainer Updated succesfully....'); window.location.href='managetrainer.php';
 </script>";
} else {
    echo
    "<script>
    alert('Not Update.....window.location.href='managetrainer.php';');
     </script>";
}
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="managetrainer.php">Edit Trainer</a>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="pid">Trainer ID : </label>
                                                <input type="text" class="form-control" name="tid" id="pid" required value="<?php echo $row['tid']; ?>" autocomplete="off"><br>

                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="pname">Trainer Name : </label>
                                                <input type="text" class="form-control" name="tname" required value="<?php echo $row['tname']; ?>" id="tname"><br>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="pdescription">Trainer Year : </label>
                                                <input type="number" class="form-control" name="tyear" id="pdescription" value="<?php echo $row['tyear']; ?>" required autocomplete="off"><br>
                                            </div>
                                            <div class="col-md-3 mb-3">
                                                <label for="duration">Timing From : </label>
                                                <input type="time" class="form-control" name="tfrom" value="<?php echo $row['tfrom']; ?>" id="duration" required autocomplete="off" min="1" max="5">
                                            </div><br>
                                            <div class="col-md-3 mb-3">
                                                <label for="fees">Timing To : </label>
                                                <input type="time" class="form-control" name="tto" id="fees" required value="<?php echo $row['tto']; ?>" autocomplete="off" pattern="[0-9]{1,20}" title="Please enter valid fees"><br>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="pprize">Trainer Fees : </label>
                                                <input type="text" class="form-control" name="fees" id="pprize" required value="<?php echo $row['fees']; ?>" autocomplete="off"><br>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="ppic">Trainer picture: </label>
                                                <input type="file" class="form-control" value="<?php echo $row['tpic']; ?>" name="tpic" id="ppic" required autocomplete="off"><br>
                                            </div>
                                        </div>
                                        <button class="btn btn-success pl-5 pr-5" type="submit" name="submit">UPDATE</button>
                                        <a class="btn btn-danger pl-5 pr-5" href="managetrainer.php">BACK</a>
                                    </form>
                                </div>
                            </div>
                        </div>
