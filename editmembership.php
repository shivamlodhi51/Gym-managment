                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th scope="col"><b>Membership Pic</b></th>
                                            <th scope="col"><b>Membership Id</b></th>
                                            <th scope="col"><b>Membership Name</b></th>
                                            <th scope="col"><b>Membership Month</b></th>
                                    ...
                                    <tbody>
                                        <tr>    
                                            ...
                                            ?>
                                                <td><?php echo $row['mpic'] ?></td>
                                                <td><?php echo $row['mid'] ?></td>
                                                <td><?php echo $row['mname'] ?></td>
                                                <td><?php echo $row['mtime'] ?></td>
                                                <td><?php echo $row['mprice'] ?></td>
                                                <td><a href="editm.php?mid=<?php echo $row['mid']; ?>" class="btn btn-primary">Edit</a></td>
                                                <td><a href="deletem.php?mid=<?php echo $row['mid']; ?>" class="btn btn-danger">Delete</a></td> 
                                        </tr>
