...
$pprize=$_POST["pprize"];
$ppic=$_POST["ppic"];
$duplicate = mysqli_query($conn, "SELECT * FROM product WHERE pid ='$pid'");
if(mysqli_num_rows($duplicate) > 0){
    ...
    alert('course Already Exists.....');
        ...
        $query= "INSERT INTO product VALUES('$pid','$pname','$pdescription','$pprize','$ppic')";
            ...
            <!-- <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="addproduct.php">Add Products</a>
                                    ...
                                    <form action="" method="post">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="pprize" id="pprize"
