...
if (isset($_POST["submit"])) {
    ...
    mysqli_query($conn, "UPDATE `membership` SET mname = '$mname', mtime = '$mtime',
    mprice = '$mprice', mpic = '$mpic', mid = '$mid' WHERE mid = $mid")or die('query failed');;

echo"<script>alert('Membership Updated succesfully....'); window.location.href='editmembership.php';</script>";
} else {
    echo"<script>alert('Membership Not Update.....window.location.href='editmembership.php';');</script>";
}

// require 'connection.php';
$mid = $_GET['mid'];
// $mid = $_POST['mid'];
$result = mysqli_query($conn, "SELECT * FROM membership WHERE mid ='$mid'");
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="editmembership.php">Edit Membership</a>
                    </div>
                </div>
            </li>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="mid" id="mid" required value="<?php echo $row['mid']; ?>" autocomplete="off"><br>

                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="mname">Membership Name : </label>
                                                <input type="text" class="form-control" name="mname" required value="<?php echo $row['mname']; ?>" id="mname"><br>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="mtime">Duration : </label>
                                                <input type="number" class="form-control" name="mtime" id="mtime" value="<?php echo $row['mtime']; ?>" required autocomplete="off"><br>
                                            </div>

                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="mprice">Membership Price : </label>
                                                <input type="text" class="form-control" name="mprice" id="mprice" required value="<?php echo $row['mprice']; ?>" autocomplete="off"><br>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="ppic">Membership picture: </label>
                                                <input type="file" class="form-control" value="<?php echo $row['mpic']; ?>" name="mpic" id="mpic" required autocomplete="off"><br>
                                            </div>
                                        </div>
                                        <button class="btn btn-success pl-5 pr-5" type="submit" name="submit">UPDATE</button>
                                        <a class="btn btn-danger pl-5 pr-5" href="editmembership.php">BACK</a>
                                    </form>
                                </div>
                            </div>
                        </div>
