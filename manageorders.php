            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="manageorders.php">Manage orders</a>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"><b>Confirm</b></th>
                                            <th scope="col"><b>Placed</b></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <td><a href="confirm.php?oid=<?php echo $row['oid']; ?>" class="btn btn-primary">Confirm</a></td>
                                                <td><a href="placed.php?oid=<?php echo $row['oid']; ?>" class="btn btn-primary">Placed</a></td>
                                                <td><a href="reject.php?oid=<?php echo $row['oid']; ?>" class="btn btn-danger">Reject</a></td> 
                                        </tr>
