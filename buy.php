            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-6 col-lg-6 col-sm-10 d-flex align-items-center justify-content-center">
                    <div class="pbox w-100">
                        <form action="makepurchase.php" class="w-100" method="post">
                            ...
                            <div class="buttn">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="state" class="form-control w-100" id="inputState" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="city" value="" min="1" max="5" required>
                                </div>
                                ...
                                <input type="hidden" name="ppic" value="<?php echo $row['ppic']; ?>">
                                <input type="hidden" name="pname" value="<?php echo $row['pname']; ?>">
                                <input type="hidden" name="pprize" value="<?php echo $row['pprize']; ?>">
                                <input type="hidden" name="status" value="pending">
                                <div class="form-group w-100">
                                    <button type="submit" class=" w-100  btn btn-primary" name="buy">Place Order</button>
                                </div>
                        </form>
                    </div>
                </div>
