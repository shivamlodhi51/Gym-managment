...
if (isset($_POST["submit"])) {
    ...
    $mprice = $_POST["mprice"];
    // $ppic=$_POST["ppic"];
    $duplicate = mysqli_query($conn, "SELECT * FROM membership WHERE mid ='$mid'");
    ...
    alert('membership Already Exists.....');
        ...
        $query = "INSERT INTO membership VALUES('$mid','$mpic','$mname','$mtime','$mprice')";
        mysqli_query($conn, $query);
        echo
        "<script>
    alert('Added Membership Successfully.....');
     </script>";
    }
}
?>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="addmembership.php">Add Membership</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add Membership</h1>
                    </div><br>
                                    ...
                                    <form action="" method="post">
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="pid">Membership ID : </label>
                                                <input type="text" class="form-control" name="mid" id="pid" required value="" autocomplete="off"><br>

                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="pname">Membership Name : </label>
                                                <input type="text" class="form-control" name="mname" required id="pname"><br>
                                            </div>
                                        </div>

                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="pprize">Month : </label>
                                                <input type="number" class="form-control" name="mtime" id="pprize" required value="" autocomplete="off"><br>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="pprize">Membership Price : </label>
                                                <input type="text" class="form-control" name="mprice" id="pprize" required value="" autocomplete="off"><br>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-12 mb-3">
                                                <label for="pprize">membership profile : </label>
                                                <input type="file" class="form-control" name="mpic" id="pprize" required value="" autocomplete="off"><br>
                                            </div>
                                        </div>
