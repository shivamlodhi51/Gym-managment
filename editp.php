...
if (isset($_POST["submit"])) {
    ...
    mysqli_query($conn, "UPDATE `product` SET pname = '$pname', pdescription = '$pdescription',
    pprize = $pprize, ppic = '$ppic', pid = '$pid' WHERE pid = $pid") or die('query failed');

echo "<script>
alert('Product Updated succesfully....'); window.location.href='manageproduct.php';
 </script>";
} else {
    echo
    "<script>
    alert('Not Update.....window.location.href='manageproduct.php';');
     </script>";
}
                                    ...
                                    <form action="" method="post">
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="pid" id="pid" required value="<?php echo $row['pid']; ?>" autocomplete="off"><br>

                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="pname">Product Name : </label>
                                                <input type="text" class="form-control" name="pname" required value="<?php echo $row['pname']; ?>" id="pname"><br>
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="pdescription">Product description : </label>
                                                <input type="text" class="form-control" name="pdescription" id="pdescription" value="<?php echo $row['pdescription']; ?>" required autocomplete="off"><br>
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="pprize">Product Price : </label>
                                                <input type="text" class="form-control" name="pprize" id="pprize" required value="<?php echo $row['pprize']; ?>" autocomplete="off"><br>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                <label for="ppic">Product picture: </label>
                                                <input type="file" class="form-control" value="<?php echo $row['ppic']; ?>" name="ppic" id="ppic" required autocomplete="off"><br>
                                            </div>
                                        </div>
                                        <button class="btn btn-success pl-5 pr-5" type="submit" name="submit">UPDATE</button>
                                        <a class="btn btn-danger pl-5 pr-5" href="manageproduct.php">BACK</a>
                                    </form>
                                </div>
                            </div>
                        </div>
