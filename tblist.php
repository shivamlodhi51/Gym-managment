...
if(!empty($_SESSION["id"])){
    $cid = $nrow["id"];
    $result = mysqli_query($conn, "SELECT * FROM tbooking WHERE cid = '$cid'");
    // $prow = mysqli_fetch_assoc($result);
}
else{
    echo "<script>alert('No Order Found'); window.location.href='dispproduct.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="pbox w-100">
                        <form action="makepurchase.php" class="w-100" method="post">
                            <div class="pimg w-100 d-flex justify-content-center">
                                <img class="" src="<?php echo $prow['tpic']; ?>" width="200px" height="200px" alt="">
                            </div>
                            <div class="pname">
                                <h2 class=""><?php echo $prow['tname']; ?></h2>
                                <h2>RS. <span><?php echo $prow['fees']; ?></span></h2>
                            </div>
                            <div class="pdis">
                                <h3>Payment Method : <?php echo $prow['pmethod']; ?></h3>
                                <h3>Booking Status : <?php echo $prow['status']; ?></h3>
                                </div>
                                <div class="buttn">
