...
if (!empty($_SESSION["id"])) {
    ...
    echo "<script>alert('Not working'); window.location.href='dispmembership.php';</script>";
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-md-6 col-lg-6 col-sm-10 d-flex align-items-center justify-content-center">
                    <div class="pbox w-100">
                        <form action="membershipbook.php" class="w-100" method="post">
                            <div class="pimg w-100 d-flex justify-content-center">
                                <img class="" src="<?php echo $row['mpic']; ?>" width="200px" height="200px" alt="">
                            </div>
                            <div class="pname">
                                <h2 class=""><?php echo $row['mname']; ?></h2>
                                <h2>RS.<span><?php echo $row['mprice']; ?></span></h2>
                                <h2>Duration : <span><?php echo $row['mprice']; ?> Month</span></h2>
                            </div>
                            <div class="buttn">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="mpic" value="<?php echo $row['mpic']; ?>">
                                <input type="hidden" name="mname" value="<?php echo $row['mname']; ?>">
                                <input type="hidden" name="mprice" value="<?php echo $row['mprice']; ?>">
                                <input type="hidden" name="status" value="Pending">
                                <div class="form-group w-100">
                                    <button type="submit" class=" w-100  btn btn-primary" name="buy">BUY</button>
                                </div>
                        </form>
                    </div>
                </div>
