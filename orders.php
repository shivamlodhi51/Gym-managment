...
if(!empty($_SESSION["id"])){
    $cid = $nrow["id"];
    $result = mysqli_query($conn, "SELECT * FROM orders WHERE cid = '$cid'");
                    ...
                    <div class="pbox w-100">
                        <form action="makepurchase.php" class="w-100" method="post">
                            <div class="pimg w-100 d-flex justify-content-center">
                                <img class="" src="<?php echo $prow['ppic']; ?>" width="200px" height="200px" alt="">
                            </div>
                            <div class="pname">
                                <h2 class=""><?php echo $prow['pname']; ?></h2>
                                <h2>RS. <span><?php echo $prow['pprize']; ?></span></h2>
                            </div>
                            <div class="pdis">
                                <h3>Payment Method : <?php echo $prow['pmethod']; ?></h3>
                                <h3>Order Status : <?php echo $prow['status']; ?></h3>
                                </div>
                                <div class="buttn">
