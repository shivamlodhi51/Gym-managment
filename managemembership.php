...
$result = mysqli_query($conn, "SELECT * FROM mbooking");
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="managemembership.php">Manage Memberships</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Membership List</h1>
                    </div><br>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col"><b>Membership ID</b></th>
                                            <th scope="col"><b>Membership Name</b></th>
                                            <th scope="col"><b>Membership Price</b></th>
                                            <th scope="col"><b>Payment Method</b></th>
                                            <th scope="col"><b>time</b></th>
                                            <th scope="col"><b>status</b></th>
                                            <th scope="col"><b>Aprove</b></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <td><a href="confirmm.php?bid=<?php echo $row['bid']; ?>" class="btn btn-primary">Confirm</a></td>
                                                <td><a href="rejectm.php?bid=<?php echo $row['bid']; ?>" class="btn btn-danger">Reject</a></td> 
                                        </tr>
                                    <?php
                                            }
