            ...
            <div class="row d-flex justify-content-evenly">
                ...
                ?>
                        <div class="col-md-4 col-lg-4 col-sm-10 d-flex align-items-center justify-content-center">
                            <div class="pbox">
                                <div class="pimg">
                                    <img src="<?php echo $row['tpic']; ?>" width="200px" height="200px" alt="">
                                </div>
                                <div class="pname">
                                ...
                                <div class="pdis">
                                    Timing
                                    <p>From : <?php echo $row['tfrom']; ?> To : <?php echo $row['tto']; ?></p>
                                    </div>
                                <div class="pdis">
                                    <p>Experience : <?php echo $row['tyear']; ?> Year</p>
                                </div>
                                <div class="buttn">
