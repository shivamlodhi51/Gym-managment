            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Manage Trainer</h1>
                    </div><br>
                        ...
                        <div class="row d-flex justify-content-center">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            <th scope="col"><b>Trainer Pic</b></th>
                                            <th scope="col"><b>Trainer Id</b></th>
                                            <th scope="col"><b>Trainer Name</b></th>
                                            <th scope="col"><b>Trainer Fees</b></th>
                                            <th scope="col"><b>Experiance year</b></th>
                                            <th scope="col"><b>Timing From</b></th>
                                            <th scope="col"><b>Timing To</b></th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            ?>
                                                <td><img width="100px" src="<?php echo $row['tpic'] ?>" alt=""></td>
                                                ...
                                                <td><a href="editt.php?tid=<?php echo $row['tid']; ?>" class="btn btn-primary">Edit</a></td>
                                                <td><a href="deletet.php?tid=<?php echo $row['tid']; ?>" class="btn btn-danger">Delete</a></td> 
                                        </tr>
