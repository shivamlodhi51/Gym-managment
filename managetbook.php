...
$result = mysqli_query($conn, "SELECT * FROM tbooking");
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="managetbook.php">Manage trainer booking</a>
                    </div>
                </div>
            </li>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            ?>
                                                ...
                                                <td><a href="confirmt.php?bid=<?php echo $row['bid']; ?>" class="btn btn-primary">Confirm</a></td>
                                                <td><a href="rejectt.php?bid=<?php echo $row['bid']; ?>" class="btn btn-danger">Reject</a></td> 
                                        </tr>
                                    <?php
                                            }
